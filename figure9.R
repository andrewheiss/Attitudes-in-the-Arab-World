#-------------------------------------------------------------------------
# Figure 9: Predicted probabilities for maintaining order, low education
#-------------------------------------------------------------------------
...
X <- cbind(my.mode(barometer$quran), my.mode(barometer$prime.minister), my.mode(barometer$citizen.influence), sample.range, 1, my.mode(barometer$age), my.mode(barometer$family.econ))

# Plot simulated probabilities
fig9 <- ologit.spaghetti(all.countries, X, y.range=sample.range,
